        ...
        function (require, module, exports) {
          ...
          var Base = /** @class */ (function () {
                ...
                fetch_1
                  ...
                  .then(function (resp) {
                    ...
                    if (
                      ...
                      var backoffDelayMs =
                        exponential_backoff_with_jitter_1.default(numAttempts_1);
                      setTimeout(function () {
            ...
            Base.prototype._getRequestHeaders = function (headers) {
              ...
              for (
                var _i = 0, _a = keys_1.default(headers);
                _i < _a.length;
                _i++
              ) {
                var headerKey = _a[_i];
            ...
            return function () {
              ...
              if (callbackArgIndex === void 0) {
                ...
                thisCallbackArgIndex =
                  callArgs.length > 0 ? callArgs.length - 1 : 0;
              } else {
        ...
        function (require, module, exports) {
          ...
          var HttpHeaders = /** @class */ (function () {
            ...
            HttpHeaders.prototype.toJSON = function () {
              var result = {};
              for (
                var _i = 0, _a = keys_1.default(this._headersByLowercasedKey);
                _i < _a.length;
                _i++
              ) {
        ...
        function (require, module, exports) {
          ...
          var Query = /** @class */ (function () {
            ...
            Query.validateParams = function (params) {
              ...
              var errors = [];
              for (
                var _i = 0, _a = keys_1.default(params);
                _i < _a.length;
                _i++
              ) {
                var key = _a[_i];
          ...
          exports.paramValidators = {
            ...
            cellFormat: typecheck_1.default(function (cellFormat) {
              return (
                ...
                ["json", "string"].includes(cellFormat)
              );
            ...
            fetch_1
              ...
              .then(function (resp) {
                ...
                if (
                  ...
                  var backoffDelayMs =
                    exponential_backoff_with_jitter_1.default(numAttempts);
                  setTimeout(function () {
                    runAction(
                      base,
                      method,
            ...
            Table.prototype._selectRecords = function (params) {
              ...
              if (isPlainObject_1.default(params)) {
                ...
                if (validationResults.errors.length) {
                  var formattedErrors = validationResults.errors.map(function (
                    error
                  ) {
                    return "  * " + error;
                  });
